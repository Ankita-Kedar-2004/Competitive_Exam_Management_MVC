...
<!-- Mirrored from codervent.com/rocker/demo/vertical/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 May 2025 07:44:39 GMT -->
<head>
	<!-- Required meta tags -->
	<meta charset="utf-8">
	...
	<script src="${pageContext.request.contextPath}/resoures/assets/js/pace.min.js"></script>
	<!-- Bootstrap CSS -->
	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				...
				<div>
					<h4 class="logo-text">Competitive Exam Management</h4>
				</div>
			...
			<ul class="metismenu" id="menu">
				<li>
					...
					<ul>
						<li> <a href="student_registration"><i class='bx bx-radio-circle'></i>Student Registration</a>
						</li>
						<li> <a href="student_view"><i class='bx bx-radio-circle'></i>Student View</a>
						</li>
						
						<li> <a href="index2.html"><i class='bx bx-radio-circle'></i>Teacher Registration</a>
						</li>
						<li> <a href="index3.html"><i class='bx bx-radio-circle'></i>View</a>
						</li>
					</ul>
				</li>
